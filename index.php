  ...
  <div class="pull-right">
  		<?php 
	        ...
	        if(isset($_SESSION['idUser'])){
	          echo '
	            <a href="product_summary.php"><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i> Item di Keranjang </span> </a> 
	          ';
	        }else{
	          echo '
	          	<a href="" disabled ><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i> Item di Keranjang </span></a> 
	            ';
	        }
	    ?>
  </div>
...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<img style="height:200dp" src="themes/images/carousel/1.png" alt="special offers"/>

		  </div>
		  </div>
		  <div class="item">
		  <div class="container">
			<img style="height:200dp" src="themes/images/carousel/2.png" alt=""/>

		  </div>
		  </div>
		  <div class="item">
		  <div class="container">
			<img style="height:200dp" src="themes/images/carousel/3.png" alt=""/>
...
<!-- Product====================================================================== -->
		...
		<hr class="soft"/>
		<p>
			Website ini menyediakan berbagai macam jamu dengan harga terjangkau dan anda dapat membelinya diwebsite ini. Sebelum melakukan pembelian diharapkan anda daftar jika belum mempunyai akun dan login jika sudah memiliki akun agar anda dapat melakukan transaksi di website kami. Selamat berbelanja.
		</p>
		<hr class="soft"/>
            ...
            <div class="row">
              <div id="'.$arrayBarang['idProduk'].'">
                ...
                <div class="span4">
                    ...
                    <h5>
                  	Stock : '.$arrayBarang['stock'].' Botol</h5>
                    <br class="clr"/>
                </div>
